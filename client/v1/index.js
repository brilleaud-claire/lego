...
// 2. Log the variable
let nbrDeals = deals.length;
console.log(nbrDeals);

// 🎯 TODO 3: Website name
// 1. Create a variable and assign it the list of shopping community name only
// 2. Log the variable
// 3. Log how many shopping communities we have
let shoppingCommunityName = [];
for (let i=0; i<deals.length; i++){
  if(shoppingCommunityName.find((Element) => Element == deals[i].community)== undefined){
...
// 2. Log the list
let dealsFiltered = deals.filter((a) => (a.discount > 50) && (a.discount < 75));
console.log(dealsFiltered);
...
const targetsup = 'f2c5377c-84f9-571d-8712-98902dcbb913';
const updatedVinted = VINTED.filter(item => item.uuid !== targetsup);
